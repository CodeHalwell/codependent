...
> `-D warnings`, `cargo test --workspace` = **≈2825 tests as of 2026-08-14**
<!-- doc-count:test sources="crates" expect=2825 label="workspace total" -->
...
- [x] **Conversation-centred shell + layout toggle** — the base view is a
      ...
      model, so the panes are context, not a separate mode. Pure-reducer; 596 TUI
<!-- doc-count:test sources="crates/tui/src" expect=596 label="TUI shell tests" -->
