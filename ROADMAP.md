...
> `-D warnings`, `cargo test --workspace` = **≈4026 tests as of 2026-09-02**
<!-- doc-count:test sources="crates" expect=4026 label="workspace total" -->
...
- [x] **Conversation-centred shell + layout toggle** — the base view is a
      ...
      model, so the panes are context, not a separate mode. Pure-reducer; 732 TUI
<!-- doc-count:test sources="crates/tui/src" expect=732 label="TUI shell tests" -->
