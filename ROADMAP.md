...
> `-D warnings`, `cargo test --workspace` = **≈4027 tests as of 2026-09-02**
<!-- doc-count:test sources="crates" expect=4027 label="workspace total" -->
...
- [x] **Conversation-centred shell + layout toggle** — the base view is a
      ...
      model, so the panes are context, not a separate mode. Pure-reducer; 733 TUI
<!-- doc-count:test sources="crates/tui/src" expect=733 label="TUI shell tests" -->
