...
> `-D warnings`, `cargo test --workspace` = **≈3832 tests as of 2026-08-19**
<!-- doc-count:test sources="crates" expect=3832 label="workspace total" -->
...
- [x] **Conversation-centred shell + layout toggle** — the base view is a
      ...
      model, so the panes are context, not a separate mode. Pure-reducer; 690 TUI
<!-- doc-count:test sources="crates/tui/src" expect=690 label="TUI shell tests" -->
