...
> `-D warnings`, `cargo test --workspace` = **≈4040 tests as of 2026-09-02**
<!-- doc-count:test sources="crates" expect=4040 label="workspace total" -->
...
- [x] **Conversation-centred shell + layout toggle** — the base view is a
      ...
      model, so the panes are context, not a separate mode. Pure-reducer; 739 TUI
<!-- doc-count:test sources="crates/tui/src" expect=739 label="TUI shell tests" -->
