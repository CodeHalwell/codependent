...
> `-D warnings`, `cargo test --workspace` = **≈4038 tests as of 2026-09-02**
<!-- doc-count:test sources="crates" expect=4038 label="workspace total" -->
...
- [x] **Conversation-centred shell + layout toggle** — the base view is a
      ...
      model, so the panes are context, not a separate mode. Pure-reducer; 737 TUI
<!-- doc-count:test sources="crates/tui/src" expect=737 label="TUI shell tests" -->
