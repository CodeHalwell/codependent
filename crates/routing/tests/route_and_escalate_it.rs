    ...
    let report = RouteEvalReport::new(
        ...
        vec![
            RouteArmResult {
                ...
                mean_cost_usd: Some(0.42),
                mean_latency_ms: Some(600.0),
                escalation_rate: Some(0.0),
                tool_call_error_rate: Some(0.02),
                unsafe_proposal_rate: Some(0.0),
            },
            RouteArmResult {
                arm: RouteArm::StaticCheap,
                task_success_rate: Some(0.58),
                // A measured zero: this arm's model IS free, which is a
                // different fact from a cost nobody measured (`None`).
                mean_cost_usd: Some(0.00),
                mean_latency_ms: Some(1600.0),
                escalation_rate: Some(0.0),
                tool_call_error_rate: Some(0.08),
                unsafe_proposal_rate: Some(0.0),
            },
            RouteArmResult {
                arm: RouteArm::RouterEscalation,
                task_success_rate: Some(0.89),
                mean_cost_usd: Some(0.14),
                mean_latency_ms: Some(950.0),
                escalation_rate: Some(0.35),
                tool_call_error_rate: Some(0.03),
                unsafe_proposal_rate: Some(0.0),
            },
        ],
    );
