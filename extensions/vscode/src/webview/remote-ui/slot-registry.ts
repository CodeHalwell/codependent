import { UI_CONTRIBUTION_POINTS, type UiContributionPoint } from "@codypendent/ui";
...
/**
 * The concrete VS Code webview host contract. A point is advertised only when
...
if (WEB_SLOT_DEFINITIONS.length !== UI_CONTRIBUTION_POINTS.length
  ...
  throw new Error("VS Code Remote UI slot registry is out of sync with the public contract");
}
